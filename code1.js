...
const solution = (dateDict)=>{
    const dateDict1 = {"Mon":null,"Tue":null,"Wed":null,"Thu":null,"Fri":null,"Sat":null,"Sun":null}
  ...
  //searching two consequtive null points
  var i =0;
  while(i<arr.length){
    if(arr[i]===null){
      var flag = 0;
  ...
  //searching three consequtive null points
  i =0;
  while(i<arr.length){
    if(arr[i]===null){
      var flag = 0;
  ...
  //searching four consequtive null points
  i =0;
  while(i<arr.length){
    if(arr[i]===null){
      var flag = 0;
  ...
  //searching five consequtive null points
  i =0;
  while(i<arr.length){
    if(arr[i]===null){
      var flag = 0;
